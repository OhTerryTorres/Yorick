...
-(void) loadSettings {
    ...
    //NSArray *arrayOfTitles = [[NSArray alloc] initWithObjects:@"gender", @"tone", @"period", @"age", @"length", @"sort", @"size", nil];
    NSArray *arrayOfTitles = [[NSArray alloc] initWithObjects:@"gender", @"tone", @"period", @"length", @"sort", @"size", nil];
    ...
    NSArray *array1 = [[NSArray alloc] initWithObjects:@"Any",@"Comedic", @"Dramatic", nil];
    ...
    NSArray *arrayOfSettingsOptions = [[NSArray alloc] initWithObjects:array0, array1, array2, array4, array5, array6, nil];
    ...
    while ( i < arrayOfSettingsOptions.count )  {
        ...
        if ( [setting.title isEqualToString:@"sort"] ) {
            setting.cell.titleLabel.text = [NSString stringWithFormat:@"Sort by"];
...
-(NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component
{
    ...
    array = [setting.settings mutableCopy];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Setting *setting = nil;
    setting = [self.settingsArray objectAtIndex:indexPath.row];
    height = setting.pickerCellIsShowing ? setting.cell.pickerView.frame.size.height : self.tableView.rowHeight;
